...
<body>
		...
		<div class="container">
			...
			<nav class="navbar navbar navbar-right">
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a class="dropdown-toggle gr"
						data-toggle="dropdown" href="#">BABY & KIDS<span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="#">Page 1-1</a></li>
							<li><a href="#">Page 1-2</a></li>
							<li><a href="#">Page 1-3</a></li>
	...
	<div class="container">
		<div class="row">
			<h3 style="text-align: center">Sorry for inconvenience- The Page
				you are looking for has a technical error.</h3>

		</div>
		<div class="row">
			<p class="gr centre">Kindly Proceed to Home Page and Report the
				error to the administrator with description mentioned below</p>
